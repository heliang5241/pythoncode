...
class spoorerClient(object):
    ...
    def spoorer(self):
        ...
        try:
            ...
            # groups = ['hzm', 'prd-ypdownorder-group', 'LogHelper']
            # groups = ['hzm','prd-ypdownorder-group','LogHelper']
            print groups
            # groups = ['*']
...
if __name__ == '__main__':
    check = spoorerClient(zookeeper_hosts='192.168.10.154:2181', zookeeper_url='/', kafka_hosts='192.168.10.157:9092', log_dir='/tmp/spoorer', timeout=3)
    check.spoorer()
